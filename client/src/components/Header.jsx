  ...
  return (
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
      <div className="text-center mt-20 mb-8">
        ...
        <p className="my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs font-extralight">Welcome to our blog, a space for sharing thoughtful stories, ideas, and experiences. Whether you're here to learn, reflect, or explore, we’re glad to have you with us.</p>
